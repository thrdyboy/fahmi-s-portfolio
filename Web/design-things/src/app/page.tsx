...
export default function Home() {
    ...
    return (
        <Wrapper>
            <div className="max-w-lg w-full bg-white p-8 rounded-xl shadow-lg flex justify-center items-center mx-auto">
                <div className="w-full text-center">
                    <h1 className="text-4xl font-semibold text-gray-800 mb-6">Welcome to Web Blog</h1>
